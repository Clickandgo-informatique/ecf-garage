 ...
 */
final class Version20230710115728 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE liste_options_vehicule (id INT AUTO_INCREMENT NOT NULL, vehicule_id INT NOT NULL, INDEX IDX_C7DC891E4A4A3511 (vehicule_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
