 ...
 */
final class Version20230518130104 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX IDX_78218C2D28319867 ON vehicules');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE INDEX IDX_78218C2D28319867 ON vehicules (liste_options_id)');
    }
}
